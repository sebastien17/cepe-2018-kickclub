...
```{r}
k_cv_sampling = 10
#seed_list = 1:k_cv_sampling
#seeds <- list(seed_list,seed_list,seed_list,17)
objControl <- trainControl(method="cv", number= k_cv_sampling, returnResamp='none', summaryFunction = prSummary, classProbs = TRUE, allowParallel = TRUE)
